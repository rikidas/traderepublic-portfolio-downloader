...
func TestParseNumericValueFromString(t *testing.T) {
	...
	testCases := []struct {
		...
		{input: "Du hast 1.000,00 € erhalten", expected: "1.000,00"},
		{input: "Du hast 1.921,89 €  investiert", expected: "1.921,89"},
		{input: "Du hast 10.000,00 € erhalten", expected: "10.000,00"},
	}
